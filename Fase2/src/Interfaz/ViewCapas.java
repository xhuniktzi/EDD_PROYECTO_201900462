 ...
 * @author Xhunik_Local
 */
public class ViewCapas extends javax.swing.JFrame {

    /**
     * Creates new form ViewCapas
     */
    public ViewCapas() {
        initComponents();
        DefaultTableModel dataModel = (DefaultTableModel) tableImages.getModel();
        
        LinkedList<Matriz> abb = Globals.capas.inorden();
        NodoSimple<Matriz> aux = abb.head;
    ...
    private void btnGenerateImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateImageActionPerformed
       ...
       Matriz m = Globals.capas.search(id);
...
//            java.util.logging.Logger.getLogger(ViewCapas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
