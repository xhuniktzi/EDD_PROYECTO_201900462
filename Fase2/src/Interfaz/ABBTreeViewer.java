 ...
 * @author Xhunik_Local
 */
public class ABBTreeViewer extends javax.swing.JFrame {
...
//            java.util.logging.Logger.getLogger(ABBTreeViewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            try {
//                new ABBTreeViewer().setVisible(true);
//            } catch (IOException ex) {
//                Logger.getLogger(ABBTreeViewer.class.getName()).log(Level.SEVERE, null, ex);
//            }
//        });
//    }
